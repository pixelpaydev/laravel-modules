...
use Pixel\Modules\Activators\FileActivator;
use Pixel\Modules\Activators\ModulesDatabaseActivator;
...
return [
    ...
    */
	...
	'stubs' => [
		...
		'files' => [
			...
			'assets/js/app' => 'Resources/assets/js/{LOWER_NAME}.js',
			...
			'contrib/sonar' => 'sonar-project.properties',
		],
		'replacements' => [
	...
	'paths' => [
        ...
        */
		'generator' => [
			...
			'public' => ['path' => 'Resources/public', 'generate' => true],
			'icons' => ['path' => 'Resources/icons', 'generate' => true],
    ...
    */
	'activators' => [
		...
		'database' => [
			'class' => ModulesDatabaseActivator::class,
			'table' => 'modules',
			'cache-key' => 'activator.installed',
			'cache-lifetime' => 604800,
		]
