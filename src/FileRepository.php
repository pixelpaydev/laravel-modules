...
use Pixel\Modules\Exceptions\InvalidAssetPath;
use Pixel\Modules\Exceptions\ModuleNotFoundException;
use Pixel\Modules\Process\Installer;
use Pixel\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
	...
	{
		$module_paths = $this->paths;

		$module_paths[] = $this->getPath();

		if ($this->config('scan.enabled')) {
			$module_paths = array_merge($module_paths, $this->config('scan.paths'));
		}
	 ...
	 * @return string
	 * @throws \Pixel\Modules\Exceptions\ModuleNotFoundException
	 */
